...
db.on('error', function (error) {
    switch (error.name) {
        // errnames.ReadOnly ==="ReadOnlyError"
        case Dexie.errnames.ReadOnly:
...
<table>
<tr><td>name</td><td>Will always be Dexie.errnames.ReadOnly === "ReadOnlyError"</td></tr>
