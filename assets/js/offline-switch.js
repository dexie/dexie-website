...
function updateSwitchFromStorage() {
  var offlineSwitch = document.getElementById('offline-switch');
  var offlineSwitchEnabled = document.getElementById('offline-switch-enabled');
  var cookieSettingsIcon = document.getElementById('cookie-settings-icon');
  offlineSwitchEnabled.style.display = '';
  cookieSettingsIcon.style.display = 'none';
